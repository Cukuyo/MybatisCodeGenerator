 ...
 **/
public class InsertSelectiveIgnore extends AbstractFunctionExport {
    ...
    public void exportDaoMapper(String prefix, Writer writer, ExportInfo exportInfo) throws IOException {
        ...
        writer.write(prefix + "<insert id=\"insertSelectiveIgnore\" useGeneratedKeys=\"true\" ");
        if (priColumn != null) {
            writer.write("keyProperty=\"" + priColumn.getName() + "\" ");
        }
        writer.write("parameterType=\"" + exportInfo.getPoPackageClassName() + "\">\n");
        writer.write(prefix + "\tinsert ignore into " + table.getName() + "\n");
